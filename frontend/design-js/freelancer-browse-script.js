document.addEventListener('DOMContentLoaded', function() {
    ...
    function setActiveCategory(selectedCategoryItem) {
        ...
        if (window.applyActiveCategoryFilter) { 
            window.applyActiveCategoryFilter();
        }
    }
    ...
    function loadCategoryFromURL() {
        ...
        // Trigger filtering after setting category from URL
        if (window.applyActiveCategoryFilter) {
            window.applyActiveCategoryFilter();
        }
    }
    ...
    window.addEventListener('popstate', function() {
        loadCategoryFromURL(); // This will also call applyActiveCategoryFilter
    });
});